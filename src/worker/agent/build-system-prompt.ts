...
- **\`find_tool_setup\`** — use this for requests such as "connect Gmail". It presents a secure connect card. The operator authorizes with the card; check \`list_mcp_servers\` for the result. Never ask for passwords, API keys, or tokens in chat.
